package com.example.project1.ui.location.viewModel
...
import com.example.project1.ui.location.model.GoogleGeoResult
...
class SearchViewModel: ViewModel() {
    ...
    fun getLocation(search: String){
        viewModelScope.launch {
            val apikey = "AIzaSyCXMiCYDRedzs3Tt05TKUr5BnClUIyVTYc"
